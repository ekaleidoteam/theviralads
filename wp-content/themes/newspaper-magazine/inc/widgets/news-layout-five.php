...
if ( ! function_exists( 'news_layout_widget_five_register' ) ) :
	function news_layout_widget_five_register() {
		/**
		 * Register Widget
		 */
		register_widget( 'news_layout_widget_five' );
	}
endif;
add_action( 'widgets_init', 'news_layout_widget_five_register' );

if ( ! class_exists( 'news_layout_widget_five' ) ) :
	/**
	* News Layout Class Two
	*/
	class news_layout_widget_five extends WP_Widget
	{
		...
		function widget( $args, $instance ){
			...
			$post_no = ! empty( $instance[ 'post_no' ] ) ? $instance[ 'post_no' ] : absint( 4 );
 			?>
			<div class="col-md-12">
                <div class="row sportlifestyle clearfix wow bounceInUp" data-wow-duration=".6s">
               		<!-- Left News Section -->
                    <div class="col-xs-12 col-sm-6">
                       	<div class="row sport_news clearfix">
                       		<?php echo $args['before_title']; ?>
								<a href=""><i class="fa <?php echo esc_attr( $icon_1 ); ?>" aria-hidden="true"></i> <span><?php echo esc_html( $title_1 ); ?></span></a>
                    ...
                    <div class="col-xs-12 col-sm-6">
                       	<div class="row lifestyle_news clearfix">
                       		<?php echo $args['before_title']; ?>
								<a href=""><i class="fa <?php echo esc_attr( $icon_2 ); ?>" aria-hidden="true"></i> <span><?php echo esc_html( $title_2 ); ?></span></a>
							<?php echo $args['after_title']; ?>
							<?php
								$arguments_2 = array(
									'cat'	=> absint( $cat_2 ),
