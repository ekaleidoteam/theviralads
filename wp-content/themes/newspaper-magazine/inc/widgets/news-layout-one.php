...
if ( ! function_exists( 'news_layout_widget_one_register' ) ) :
	function news_layout_widget_one_register() {
		/**
		 * Register Widget
		 */
		register_widget( 'news_layout_widget_one' );
	}
endif;
add_action( 'widgets_init', 'news_layout_widget_one_register' );

if ( ! class_exists( 'news_layout_widget_one' ) ) :
	/**
	* News Layout Class one
	*/
	class news_layout_widget_one extends WP_Widget
	{
		...
		function widget( $args, $instance ){
			...
			echo $args[ 'before_widget' ];
						...
						while( $query->have_posts() ) :
							...
							?>
								<div class="col-xs-12 col-sm-6">
                        			<div class="block_first_article wow bounceInUp" data-wow-duration=".6s">
				...
				?>
					<div class="col-xs-12 col-sm-6">
                        <div class="block_left_article clearfix wow bounceInUp" data-wow-duration=".6s">
						<?php
							if( $query->have_posts() ) :
								while( $query->have_posts() ) :
									$query->the_post();
