											...
											<div class="view hm-zoom hm-black-light">
												<?php
													if( has_post_thumbnail() ) :
														the_post_thumbnail( 'newspaper-magazine-thumbnail-1', array( 'class' => 'img-fluid' ) );
													endif;
												?>
							                    <div class="mask flex-center"></div>
							                    
							                </div>
							                <div class="breakingnews_titles wow bounceInDown" data-wow-duration="2s">
	                  		...
	                  		?>
			                      		<div class="right_top clearfix">
			                        		<div class="view hm-zoom hm-black-light">
												<?php
													if( has_post_thumbnail() ) :
														the_post_thumbnail( 'newspaper-magazine-thumbnail-2', array( 'class' => 'img-fluid' ) );
													endif;
												?>
							                    <div class="mask flex-center"></div>
							                </div>
							                <div class="breakingnews_titles wow bounceInLeft" data-wow-duration="2s">
							                    <div class="breaking_category">
							                    	<?php
							                    		$categories_list = get_the_category_list( esc_html__( ', ', 'newspaper-magazine' ) );
							                    	?>
					                ...
					                <div class="item">
					                    <div class="singleslidingnews">
					                      <div class="view hm-zoom hm-black-light">
					                            <?php
													if( has_post_thumbnail() ) :
														the_post_thumbnail( 'newspaper-magazine-thumbnail-3', array( 'class' => 'img-fluid' ) );
													endif;
												?>
					                            <div class="mask flex-center"></div>
					                      </div>
