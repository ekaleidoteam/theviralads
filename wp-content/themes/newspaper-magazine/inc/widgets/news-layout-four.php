...
if ( ! function_exists( 'news_layout_widget_four_register' ) ) :
	function news_layout_widget_four_register() {
		/**
		 * Register Widget
		 */
		register_widget( 'news_layout_widget_four' );
	}
endif;
add_action( 'widgets_init', 'news_layout_widget_four_register' );

if ( ! class_exists( 'news_layout_widget_four' ) ) :
	/**
	* News Layout Class Two
	*/
	class news_layout_widget_four extends WP_Widget
	{
		...
		function widget( $args, $instance ){
			...
			echo $args[ 'before_widget' ];
				...
				?>
							<div class="col-xs-12">
			                    <div class="row technology_top_news">
				                    ...
				                    ?>
			                        <div class="breakingnews_titles wow bounceInUp" data-wow-duration=".6s">
				...
				?>			
				<div class="row">
                    <div class="technology_bottom_news wow bounceInUp" data-wow-duration=".6s">	
                    <?php
                    	if( $query->have_posts() ) :
							while( $query->have_posts() ) :
								$query->the_post();
