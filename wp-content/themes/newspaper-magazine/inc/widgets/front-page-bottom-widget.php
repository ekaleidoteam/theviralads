...
if ( ! function_exists( 'news_layout_widget_six_register' ) ) :
	function news_layout_widget_six_register() {
		/**
		 * Register Widget
		 */
		register_widget( 'news_layout_widget_six' );
	}
endif;
add_action( 'widgets_init', 'news_layout_widget_six_register' );

if ( ! class_exists( 'news_layout_widget_six' ) ) :
	/**
	* News Layout Class Two
	*/
	class news_layout_widget_six extends WP_Widget
	{
