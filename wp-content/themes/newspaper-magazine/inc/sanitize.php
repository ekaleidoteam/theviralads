 ...
 */
function newspaper_magazine_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function newspaper_magazine_sanitize_css( $css ) {
 ...
 */
function newspaper_magazine_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function newspaper_magazine_sanitize_email( $email, $setting ) {
 ...
 */
function newspaper_magazine_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function newspaper_magazine_sanitize_html( $html ) {
 ...
 */
function newspaper_magazine_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function newspaper_magazine_sanitize_nohtml( $nohtml ) {
 ...
 */
function newspaper_magazine_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function newspaper_magazine_sanitize_number_range( $number, $setting ) {
 ...
 */
function newspaper_magazine_sanitize_select( $input, $setting ) {
 ...
 */
function newspaper_magazine_sanitize_url( $url ) {
 ...
 * @return int
 */
function newspaper_magazine_sanitize_category($input){
	$output=intval($input);
	return $output;
}
 ...
 * @return string
 */
function newspaper_magazine_sanitize_sidebar( $input ) {
	$valid = array(
		'left'   => 'Left',
		'right'  => 'Right',
		'none'	 => 'None',
